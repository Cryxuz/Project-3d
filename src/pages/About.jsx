...
const About = () => {
  return (
    <section className="max-container">
      ...
      <a target='_blank' href="https://drive.google.com/file/d/1Xfy7kere4XNeWU9rGCz3o3V3jiw4FJzl/view?usp=share_link" rel="noreferrer"><button className='btn mt-6'>Download CV</button></a>
